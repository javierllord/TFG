...
%
%--- Referencias -------------------------------------------------------------&
\newcommand{\Chp}[1]{{\small\sffamily\bfseries Capítulo \ref{chap:#1}}}
...
\newcommand{\Eqr}[1]{{\small\sffamily\bfseries Ecuación \ref{eq:#1}}}
\newcommand{\Eqn}[1]{{(\small\ref{eq:#1})}}
\newcommand{\Pag}[1]{{\small\sffamily\bfseries Pág. \pageref{#1}}}
%-----------------------------------------------------------------------------&
%
...
%% \renewcommand{\bibname}{Bibliografí­a}
